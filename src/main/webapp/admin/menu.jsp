	...
	<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      ...
	      <dl class='bitem'>
	        <dt onClick='showHide("items6_1")'><b>滁州美食管理</b></dt>
	        <dd style='display:block' class='sitem' id='items6_1'>
	          <ul class='sitemu'>
	             <li><a href='<%=path %>/admin/picNews/picNewsAdd.jsp' target='main'>美食信息添加</a> </li>
	             <li><a href='<%=path %>/picNewsMana.action' target='main'>美食信息管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
	       <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items5_1")'><b>菜系管理</b></dt>
	        <dd style='display:block' class='sitem' id='items5_1'>
	          <ul class='sitemu'>
	             <li><a href='<%=path %>/catelogMana.action' target='main'>菜系管理</a> </li>
	              <li><a href='<%=path %>/admin/catelog/catelogAdd.jsp' target='main'>添加菜系</a> </li>
	      ...
	      <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items5_1")'><b>店铺管理</b></dt>
	        <dd style='display:block' class='sitem' id='items5_1'>
	          <ul class='sitemu'>
	             
	              <li><a href='<%=path %>/admin/product/productNoTejiaAdd.jsp' target='main'>添加店铺</a> </li>
	             <li><a href='<%=path %>/productManaNoTejia.action' target='main'>店铺管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items6_1")'><b>用户管理</b></dt>
	        <dd style='display:block' class='sitem' id='items6_1'>
	          <ul class='sitemu'>
	             <li><a href='<%=path %>/userMana.action' target='main'>用户管理</a> </li>
	          <li><a href='<%=path %>/goodsMana.action' target='main'>美文管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
