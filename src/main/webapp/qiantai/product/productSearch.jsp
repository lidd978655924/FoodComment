		            ...
		            <div class="list pic_news">
						  	...
						  	<table width="99%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" align="center" style="margin-top:8px">
								  ...
								  <tr align='center' bgcolor="#FFFFFF" height="22">
									  ...
									  <td>￥<s:property value="#product.productShichangjia"/></td>
									  <td>
									      <s:if test="#product.productShichangjia==#product.productTejia">
									          无特价
									      </s:if>
									      <s:else>
									  ...
									  <td><a href="<%=path %>/productDetail.action?productId=<s:property value="#product.productId"/>"> <img src="<%=path %>/<s:property value="#product.productPic"/>" width="70 height="48" border="0"/> </a></td>
