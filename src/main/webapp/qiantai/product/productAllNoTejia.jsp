	...
	<body>
		...
		<div class="page_row">
			...
			<div class="page_main_msg left">		
              ...
              <a href="productAllNoTejia.action?topage=1">首页</a>
              <a href="productAllNoTejia.action?topage=${showpage-1}">上一页</a>
              </c:if>
               <c:if test="${showpage<pagecount}">
              <a href="productAllNoTejia.action?topage=${showpage+1}">下一页</a>
              <a href="productAllNoTejia.action?topage=${pagecount}">最后一页</a>
              </c:if>
              第${showpage}页
              一共${pagecount}页
		             </div>
