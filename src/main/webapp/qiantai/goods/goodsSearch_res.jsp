...
<div id="MainCenter" align="center" class="MainCenter">
		 ...
		 <div id="content" class="Sub">
				<div class="NewContainer770">
					...
					<div class="Slot">
						<table width="99%" border="0" cellpadding="2" cellspacing="5" bgcolor="#FFFFFF" align="center" style="margin-top:8px">
								  ...
								  <tr align='center' bgcolor="#FFFFFF" height="22">
								      ...
								      <td><a href="<%=path %>/goodsDetail.action?goodsId=<s:property value="#goods.goodsId"/>">文章内容</a></td>
								  </tr>
								  </s:iterator>
		        		</table>
                    </div>
