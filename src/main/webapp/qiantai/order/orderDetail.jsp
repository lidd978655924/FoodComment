...
<html>
  <head>
	...
	<style type="text/css">
		...
		.C_product_Title{ border:1px solid #ccc; background:url(<%=path %>/images/Bule_46.gif) repeat-x; margin-bottom:5px; height:32px;}
		.C_product_Border{ border-top:4px solid #4380CC; padding-top:10px;}
  ...
  <body class="body" leftmargin="0" rightmargin="0">
     <table cellspacing="1" cellpadding="0" width="100%" border="0" bgcolor="#F7F3F7">
		  ...
		  <tr class="text" align="center" bgcolor="#FFFFFF">
			  <td>
				<s:property value="#orderItem.product.productName"/>
			  </td>
			  <td><s:property value="#orderItem.productQuantity"/></td>
			  <td><s:property value="#orderItem.product.productTejia"/></td>
		  </tr>
		  </s:iterator>
  	</table>
  </body>
