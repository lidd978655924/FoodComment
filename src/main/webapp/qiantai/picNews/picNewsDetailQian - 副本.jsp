...
<div id="MainCenter" align="center" class="MainCenter">
		 ...
		 <div id="content" class="Sub">
				<div class="NewContainer770">
					<div class="BoxHeader">
						<div class="BoxHeader-center MarginTop10">新闻详细信息</div>
					</div>
					<div class="Slot">
						<table width="100%" border="0">
						    <tr>
						       <td align="center"><img width="200" height="200" src="<%=path %>/<s:property value="#request.picNews.fujian"/>"/><hr/></td>
						    </tr>
						    <tr>
						       <td align="center"><s:property value="#request.picNews.picNewsContent" escape="false"/><hr/></td>
						    </tr>
						    <tr>
